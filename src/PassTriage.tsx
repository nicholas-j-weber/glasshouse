...
// spec.md "The Pass" — one assistant reply's lanes (context sent, reasoning
// trace), side by side, replacing the old separate per-message
// ReasoningTrace toggle. Every assistant message gets this trigger, even a
// plain blackbox text reply with nothing in the reasoning-trace pane — that
// pane still gets an honest empty state rather than being hidden.
